...
CREATE TABLE `butaca` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_sala` (`id_sala`),
  CONSTRAINT `butaca_ibfk_1` FOREIGN KEY (`id_sala`) REFERENCES `sala` (`id`)
...
INSERT INTO `pelicula` VALUES (1,'Viejas Amigas','Una comedia sobre la amistad y la vida en la tercera edad','2024-01-01','2024-01-30',1,3,80.00,'https://example.com/trailer/viejasamigas','img/peliculas/Amigas.png','Estreno',1,'https://example.com/portada/demonslayer'),(2,'DeadPool 3','El anti-héroe más irreverente del universo Marvel','2024-02-01','2024-02-28',4,4,108.00,'https://www.youtube.com/embed/UzFZR2dRsSY?enablejsapi=1','img/peliculas/dealpool.png','Pre-venta',1,'img/portadas/PortadaDeadPool3.jpg'),(3,'DemonSlayer','Un joven cazador de demonios busca venganza y redención','2024-03-01','2024-03-31',4,3,103.00,'https://example.com/trailer/demonslayer','img/peliculas/DemonSlayer.png','Estreno',1,'https://example.com/portada/demonslayer'),(4,'El Club De Los Vandalos','Un grupo de adolescentes rebeldes cambia su vida a través del arte','2024-04-01','2024-04-30',4,3,116.00,'https://example.com/trailer/clubdelosvandalos','img/peliculas/ElclubDelosVandalos.png','Pelicula',1,'https://example.com/portada/clubdelosvandalos'),(5,'Garfield','El gato más perezoso y cómico del mundo','2024-05-01','2024-05-31',3,3,101.00,'https://example.com/trailer/garfield','img/peliculas/Garfield.png','Estreno',1,'https://example.com/portada/garfield'),(6,'Godzilla','El regreso del rey de los monstruos','2024-06-01','2024-06-30',4,4,115.00,'https://example.com/trailer/godzilla','img/peliculas/Godzila.png','Pelicula',1,'https://example.com/portada/godzilla'),(7,'Guason2','La continuación de la historia del villano más famoso de Gotham','2024-07-01','2024-07-31',5,4,122.00,'https://example.com/trailer/guason2','img/peliculas/Guason2.png','Pre-venta',1,'https://example.com/portada/guason2'),(8,'Intensamente 2','Las emociones vuelven con nuevas aventuras','2024-08-01','2024-08-31',3,3,96.00,'https://www.youtube-nocookie.com/embed/9bol4Yyx9Gs?si=6oVmq6EI9ygi2Y2W','img/peliculas/Intensamente2.png','Pre-venta',1,'https://example.com/portada/intensamente2'),(9,'OnePiece','El viaje épico de los piratas en busca del tesoro','2024-09-01','2024-09-30',4,3,51.00,'https://example.com/trailer/onepiece','img/peliculas/onepiece.jpg','Pre-venta',1,'https://example.com/portada/onepiece'),(10,'Planeta de los Simios','La guerra por el dominio del planeta entre humanos y simios','2024-10-01','2024-10-31',4,4,145.00,'https://example.com/trailer/planetadelossimios','img/peliculas/Pelicula.png','Pelicula',1,'https://example.com/portada/planetadelossimios'),(11,'Tarot','Una historia de misterio y predicciones que cambian vidas','2024-11-01','2024-11-30',2,4,92.00,'https://example.com/trailer/tarot','img/peliculas/Tarot.png','Pre-venta',1,'https://example.com/portada/tarot'),(12,'Transformers','La batalla entre Autobots y Decepticons continúa','2024-12-01','2024-12-31',4,3,127.00,'https://example.com/trailer/transformers','img/peliculas/Transformers.jpg','Pelicula',1,'https://example.com/portada/transformers');
...
INSERT INTO `peliculaFormato` VALUES (1,1,1),(2,1,2),(3,1,3),(4,2,1),(5,2,2),(6,2,3),(7,3,1),(8,3,2),(9,3,3),(10,4,1),(11,4,2),(12,4,3),(13,5,1),(14,5,2),(15,5,3),(16,6,1),(17,6,2),(18,6,3),(19,7,1),(20,7,2),(21,7,3),(22,8,1),(23,8,2),(24,8,3),(25,9,1),(26,9,2),(27,9,3),(28,10,1),(29,10,2),(30,10,3),(31,11,1),(32,11,2),(33,11,3),(34,12,1),(35,12,2),(36,12,3);
...
-- Dump completed on 2024-07-15 13:18:33
